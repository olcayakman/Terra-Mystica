...
public class ActionHandler {
	 ...
	 */
	public void terraformAndBuild(String targetTerrainType) {
	 ...
	 */
	public void sendPriestToCultBoard(String cultType, int priestPosition) {
	 ...
	 * @param id
	 */
	public void powerAction(int id) {
	 ...
	 * @param id
	 */
	public void specialAction(int id) {
	...
	public void showPlayAbleActions() {
	 ...
	 * @param terrains
	 */
	public ActionHandler(Faction faction, ArrayList<Faction> terrains) {

...
public class Cost extends IncomeOrCost {
    ...
    private Cost(int worker, int coin, int priest, int power, int spade, int victoryPoints) {
        super(worker, coin, priest, power, spade, victoryPoints);
    }

    public static Cost withWorkerAndCoin(int worker, int coin) {
        return new Cost(worker, coin, 0, 0, 0, 0);
    }

    public static Cost withWorkerCoinAndPriest(int worker, int coin, int priest) {
        return new Cost(worker, coin, priest, 0, 0, 0);
    }

    public static Cost withCoinAndPriest(int coin, int priest) {
        return new Cost(0, coin, priest, 0, 0, 0);
    }

    public static Cost withPower(int power) {
        return new Cost(0, 0, 0, power, 0, 0);
    }

    public static Cost withSpade(int spade) {
        return new Cost(0, 0, 0, 0, spade, 0);
    }
